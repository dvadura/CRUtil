...
#define BI_SHI   BI_UB64[W64(1)]
   ...
   // Complete pair<class,class> unsigned when it becomes required, use same stragegy
   // as pair<uint64_t,uint64_t> but take advantange of intrinsic 128 bit ints if available.
   typedef pair<uint128_t,uint128_t> uint256_dont_use_t;
